/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: 93cb7b98ec965dd3b974c7e294773e85)
// Runtime types generated with workerd@1.20260722.1 2026-08-24 nodejs_compat
interface __BaseEnv_Env {
	STAGING_KV: KVNamespace;
	USER_BACKUPS: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	BACKEND_ONLY: "true";
	...
	AUTH_EMAIL_FROM: "no-reply-staging@bridgecrm.dev";
	AUTH_EMAIL_NAME: "Bridge CRM Staging";
	TURNSTILE_SITE_KEY: "";
	ENVIRONMENT: "staging";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BACKEND_ONLY" | "ALLOWED_ORIGINS" | "PUBLIC_APP_URL" | "AUTH_ENABLED" | "AUTH_REQUIRE_TURNSTILE" | "AUTH_EMAIL_FROM" | "AUTH_EMAIL_NAME" | "TURNSTILE_SITE_KEY" | "ENVIRONMENT">> {}
}

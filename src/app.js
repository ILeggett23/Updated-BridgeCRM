...
function activateWalkthroughDestination(destination) {
  ...
  if (destination === "capture-context") {
    ...
    return new Promise(resolve => requestAnimationFrame(() => {
      ...
      if (form) setQuickCaptureStep(form, 2, { direction: "forward", behavior: "auto" });
...
function renderContacts() {
  ...
  return `<section class="people-home" aria-label="People" data-tour="people-workspace">
    <header class="people-home__header" data-tour="people-overview"><h1 class="primary-page-title">People</h1><button class="people-home__places" type="button" data-people-contact-mode="places" aria-label="Browse places">${icons.location}</button></header>

...
self.addEventListener("push", event => {
  ...
  const options = {
    ...
    icon: new URL("bridge-app-icon-192.png?v=1.3.46", ROOT).href,
    badge: new URL("bridge-app-icon-192.png?v=1.3.46", ROOT).href,

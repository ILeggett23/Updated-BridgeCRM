...
test("iPhone web app assets are included in the production worker", () => {
  assert.ok(worker.includes("brand-icon.js"));
  assert.ok(worker.includes("favicon-16x16.png"));
  assert.ok(worker.includes("favicon-32x32.png"));
  assert.ok(worker.includes("favicon-48x48.png"));
  assert.ok(worker.includes("apple-touch-icon.png"));
  assert.ok(worker.includes("bridge-ui-mark.svg"));
  assert.ok(worker.includes("bridge-app-icon-192.png"));
  assert.ok(worker.includes("bridge-app-icon-512.png"));
  assert.ok(worker.includes("bridge-app-icon-maskable-192.png"));
  assert.ok(worker.includes("bridge-app-icon-maskable-512.png"));
  assert.ok(worker.includes("bridge-app-icon-1024.png"));
